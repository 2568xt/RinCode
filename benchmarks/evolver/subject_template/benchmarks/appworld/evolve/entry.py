...
from rincode.evolver.launch.contract import BenchBundle, LaunchContext, validate_whitelist
from rincode.evolver.orchestrator.gates.policy import make_frozen_baseline
from rincode.evolver.orchestrator.gates.strategies import FocusedFisherGate, confirm_job_name
from rincode.evolver.orchestrator.scoring import eval_with_infra_rerun, with_infra_rerun
...
def build(ctx: LaunchContext) -> BenchBundle:
    ...
    def read_stability():
        from rincode.evolver.analysis.stability_bucket import TaskStability, _bucket_for
    ...
    from rincode.evolver.orchestrator.scoring import EvalBackend
    ...
    if test_ids:
        ...
        def unseal(records: list[dict], orch) -> dict:
            ...
            from rincode.evolver.orchestrator.sealed.runner import SealedTestRunner, unseal_retention
