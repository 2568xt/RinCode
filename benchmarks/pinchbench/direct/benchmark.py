#!/usr/bin/env python3
"""
PinchBench Benchmark Runner - adapted for RinCode.
...
from rincode_executor import (  # noqa: E402
    DEFAULT_API_BASE,
    DEFAULT_API_KEY,
    DEFAULT_MODEL,
    DEFAULT_PROVIDER,
...
def _parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="PinchBench for RinCode")
    parser.add_argument(
        "--model",
...
async def run_benchmark(args: argparse.Namespace) -> None:
    ...
    logger.info("=" * 70)
    logger.info("  PinchBench for RinCode")
    ...
    run_root = Path("/tmp/pinchbench-rincode")
