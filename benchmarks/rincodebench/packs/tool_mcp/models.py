...
from benchmarks.rincodebench.fixtures.mcp import receipt_payload
from benchmarks.rincodebench.schema import TaskSpec
...
class ToolTarget:
    ...
    def runtime_name(self) -> str:
        return f"mcp_rincodebench_{self.tool_name}"
