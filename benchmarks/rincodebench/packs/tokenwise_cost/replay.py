...
from rincode.utils.atomic_io import atomic_replace
...
REPLAY_REPORT_SCHEMA = "rincode.rincodebench.call-efficiency-replay.report.v1"
...
def verify_legacy_report(
    ...
    *,
    ...
    report = {
        ...
        "source_rincode_commit": campaign.get("rincode_commit"),
