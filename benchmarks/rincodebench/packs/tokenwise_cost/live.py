...
from rincode.token_wise.base import TokenStrategy
...
TASK_CORPUS_SCHEMA = "rincode.rincodebench.tokenwise-cost.tasks.v1"
REPORT_SCHEMA = "rincode.rincodebench.tokenwise-cost.report.v1"
CURRENT_REPORT_SCHEMA = "rincode.rincodebench.call-efficiency-cost.report.v2"
...
class CampaignConfig:
    ...
    output_root: Path = Path(".rincode/evidence/call-efficiency-cost-current")
