...
from benchmarks.rincodebench.protocol import RetrievalContext, RetrievalExecution
from benchmarks.rincodebench.records import RetrievalStatus
...
from rincode.utils.bm25 import BM25Okapi, tokenize
    ...
    def _local_source(self, workspace_id: str) -> LocalSkillSource:
        ...
        metas = [
            SkillMeta(
                ...
                path=Path("/rincodebench") / item.item_id / "SKILL.md",
                content=item.text,
                source="local",
            )
