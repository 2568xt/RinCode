...
from benchmarks.rincodebench.budget import ProviderBudgetLedger
from benchmarks.rincodebench.canonical import canonical_digest
from rincode.context_engine.base import AssemblyContext
from rincode.context_engine.segments import MemorySegmentBuilder, SkillsSegmentBuilder
from rincode.memory_engine import Memory, TokenBudget
from rincode.memory_engine.skill_forge import (
    LocalSkillSource,
    RouterHit,
    SkillForgeRouter,
)
from rincode.memory_engine.skill_local import LocalPool, SkillMeta
...
class SemanticRuntimeConfig:
    ...
    semantic_schema: str = "rincode.rincodebench.semantic-addendum.v1"
    ...
    *,
    ...
    metas = [
        SkillMeta(
            ...
            name=item.logical_id,
            description=item.text,
            path=Path("/rincodebench-semantic") / item.item_id / "SKILL.md",
            content=item.text,
            source="local",
        )
        for item in corpus
