...
``rincode.evolver.orchestrator``; only the AppWorld brain is wired here:
...
from rincode.evolver.orchestrator.gates.policy import make_frozen_baseline
from rincode.evolver.orchestrator.gates.strategies import (
    FocusedFisherGate,
    confirm_job_name,
)
from rincode.evolver.orchestrator.loop import EvolutionOrchestrator
from rincode.evolver.orchestrator.nodes.taxonomy import resolve_taxonomy
from rincode.evolver.orchestrator.production import build_evolution_orchestrator
from rincode.evolver.tree.node import HarnessNode
...
def build_appworld_orchestrator(
    *,
    ...
    if analysis_mode == "agentic":
        ...
        from rincode.evolver.orchestrator.providers.claude_agentic import (
    ...
    def baseline_of():
        if baseline_mode == "same_session":
            from rincode.evolver.orchestrator.gates.policy import (
    ...
    # 设施重跑阶梯兄弟目录的并集。
    from rincode.evolver.activation.ledger import read_fired_tasks
    ...
    if zero_hit_preflight:
        from rincode.evolver.orchestrator.production import make_zero_hit_preflight
...
def build_appworld_sealed_runner(
    *,
    ...
    :func:`rincode.evolver.orchestrator.sealed.runner.unseal_retention` after the
    loop finishes.
    """
    from rincode.evolver.orchestrator.scoring import eval_with_infra_rerun
