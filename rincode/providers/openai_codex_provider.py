...
Provider 把 RinCode Chat Messages/Function Schema 转成 Codex Responses Flat Items，从 oauth-cli-kit
    ...
    async def chat(
        ...
        try:
            ...
            raise RuntimeError(
                ...
                "Tool install: uv tool install --force 'rincode-harness[channels,tools]'."
            ) from e
...
def _build_headers(account_id: str, token: str) -> dict[str, str]:
    return {
        ...
        "User-Agent": "rincode-harness (python)",
