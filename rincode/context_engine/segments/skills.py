...
from rincode.context_engine.segments import render
...
if TYPE_CHECKING:
    ...
    from rincode.memory_engine.skill_forge.types import RouterHit
    ...
    def __init__(
        ...
        *,
        ...
        if router is None:
            ...
            from rincode.memory_engine.skill_forge import LocalSkillResolver
