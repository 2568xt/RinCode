...
from rincode.agent.loop.recovery import limits_from_defaults
...
def assemble_runtime(
    ...
    *,
    ...
    from rincode.agent.loop import AgentLoop
    from rincode.call_efficiency import CallEfficiency, CallEfficiencyProvider
    from rincode.cli._plugin_stack import (
    ...
    try:
        ...
        agent_loop = AgentLoop(
            ...
            context_config=rincode_config.context,
            context_engine_factory=context_engine_factory,
            runtime_config=rincode_config.runtime,
            interactive=interactive,
            backend=backend,
            memory_config=rincode_config.memory,
            skill_forge_router_config=rincode_config.skill_forge.router,
