...
if TYPE_CHECKING:
    ...
    from rincode.proactive_engine.schedulers.cron.types import CronJob
    from rincode.session.manager import SessionManager
    from rincode.spine import TurnHandle, TurnRequest
...
def make_on_cron_job(
    ...
    *,
    ...
    async def on_cron_job(job: "CronJob") -> str | None:
        ...
        from rincode.proactive_engine.schedulers.cron.tool import (
