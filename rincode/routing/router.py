"""RinCode 的 EcoClaw-style Model Router，对外串联分类、评测数据与模型选择。
...
from rincode.routing.classifier import PromptClassifier
from rincode.routing.fetcher import BenchmarkData
from rincode.routing.selector import select_model
from rincode.routing.types import RoutingProfileName, SelectionResult
