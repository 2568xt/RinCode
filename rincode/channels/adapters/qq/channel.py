...
本模块解决的是 QQ 平台事件如何进入 RinCode Runtime、Runtime 文本回复又如何回到原会话。
...
from rincode.channels.adapters.qq import parsing
from rincode.channels.base import ChannelBase
from rincode.channels.errors import transient_network
from rincode.channels.media import safe_name
from rincode.config.schema import QQConfig
