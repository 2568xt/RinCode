"""把 WeCom（Enterprise WeChat）AI bot 消息接入 RinCode Runtime。
...
from rincode.channels.media import safe_name, save_media_bytes
from rincode.config.schema import WecomConfig
