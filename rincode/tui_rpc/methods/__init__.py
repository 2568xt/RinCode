...
from rincode.tui_rpc.methods.config import register_config_methods
from rincode.tui_rpc.methods.confirm import register_confirm_methods
from rincode.tui_rpc.methods.image import register_image_methods
from rincode.tui_rpc.methods.model import register_model_methods
from rincode.tui_rpc.methods.question import register_question_methods
from rincode.tui_rpc.methods.session import register_session_methods
from rincode.tui_rpc.methods.setup import register_setup_methods
from rincode.tui_rpc.methods.system import register_system_methods
from rincode.tui_rpc.methods.terminal import register_terminal_methods
from rincode.tui_rpc.methods.turn import register_turn_methods

if TYPE_CHECKING:
    from rincode.spine.scheduler import Scheduler
    from rincode.tui_rpc.confirm_broker import ConfirmBroker
    from rincode.tui_rpc.dispatcher import Dispatcher
    from rincode.tui_rpc.errors import RpcError
    from rincode.tui_rpc.methods.session import AgentLoopFactory
    from rincode.tui_rpc.methods.turn import SchedulerFactory
