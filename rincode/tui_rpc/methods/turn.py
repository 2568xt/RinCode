"""实现把 TUI request 接入 RinCode Spine 的 ``turn.*`` handlers。
...
from rincode.spine import ChatType, Origin, Source, TurnHandle, TurnRequest
from rincode.spine.scheduler import Scheduler, SchedulerDrainingError
from rincode.tui_rpc.errors import RpcError, TurnInProgressError
from rincode.tui_rpc.methods.image import consume_pending_images, pending_images
