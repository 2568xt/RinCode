...
from rincode.tui_rpc.methods.image import clear_pending_images
from rincode.tui_rpc.methods.system import _rincode_version

if TYPE_CHECKING:
    from rincode.agent.loop.main import AgentLoop
...
# site-packages 的 dist-info。system._rincode_version() 已兼容源码检出环境中的 PackageNotFoundError。
_RINCODE_VERSION = _rincode_version()
...
def register_session_methods(
    ...
    *,
    ...
    该实现镜像 :func:`rincode.tui_rpc.methods.turn.register_turn_methods`：用单参数 closure
