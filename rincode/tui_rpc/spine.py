"""装配 TUI RPC Turn 在 RinCode Spine 中经过的 runner、hub、outlet 与 sink。
...
from rincode.spine.delivery import Capabilities, DeliveryHub
from rincode.spine.events import TurnEvent
from rincode.spine.runner import Drain, Emit
