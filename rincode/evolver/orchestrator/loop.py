...
an injected :class:`~rincode.evolver.orchestrator.scoring.EvalBackend`; the
...
if TYPE_CHECKING:
    from rincode.evolver.orchestrator.state.journal import RoundJournal

from rincode.evolver.candidate_manifest import ManifestGateError
from rincode.evolver.orchestrator.archive import (
    CellElite,
    GsmeArchive,
    describe_candidate,
)
from rincode.evolver.orchestrator.config import OrchestratorConfig
from rincode.evolver.orchestrator.gates.fisher import train_mean
...
from rincode.evolver.orchestrator.gates.strategies import PairedTwoSigmaGate
from rincode.evolver.orchestrator.nodes.diagnose import merge_failure_maps
...
from rincode.evolver.orchestrator.sealed.runner import assert_no_test_leak
from rincode.evolver.orchestrator.termination import TerminationTracker
from rincode.evolver.scheduler.anchor_selection import AnchorSelection
from rincode.evolver.tree.node import AppliedPatch, HarnessNode, NodeStatus
...
class EvolutionOrchestrator:
    ...
    def _sentinel_pools(self) -> tuple[list[str], list[str]]:
        from rincode.evolver.analysis.stability_bucket import StabilityBucket
