...
from rincode.evolver.analysis.stability_bucket import (
    TaskStability,
    _bucket_for,
)
from rincode.evolver.judge.llm_client import JudgeLLMBackend
from rincode.evolver.judge.parser import JudgeParseError, parse_pass_fail
from rincode.evolver.judge.prompts import build_pass_fail_messages
from rincode.evolver.orchestrator.config import Budget, OrchestratorConfig
from rincode.evolver.orchestrator.loop import (
    EvolutionOrchestrator,
    RoundResult,
    summarize_round,
)
from rincode.evolver.orchestrator.nodes.design import design_round
from rincode.evolver.orchestrator.nodes.diagnose import diagnose_round
from rincode.evolver.orchestrator.nodes.semantic import CallFn, SemanticNode
from rincode.evolver.orchestrator.nodes.verdict import draft_verdict
from rincode.evolver.orchestrator.scoring import (
    EvalBackend,
    TaskEval,
    TrajectorySource,
)
from rincode.evolver.scheduler.anchor_selection import simple_anchor
from rincode.evolver.tree.node import AppliedPatch, HarnessNode
...
def make_git_commit_apply_fn(
    ...
    *,
    ...
    from rincode.evolver.applier import assert_patch_allowed
    from rincode.evolver.tree import git_ops
...
def make_git_recombine_fn(repo_root: str | Path):
    ...
    """
    from rincode.evolver.orchestrator.archive import CellElite, RecombinantCandidate
    from rincode.evolver.tree import git_ops
    from rincode.evolver.tree.git_ops import GitOpError
...
def make_sealed_runner(
    ...
    *,
    ...
    """
    from rincode.evolver.orchestrator.sealed.runner import SealedTestRunner
...
def build_evolution_orchestrator(
    ...
    *,
    ...
    from rincode.evolver.orchestrator.archive import GsmeArchive
    ...
    def _record_candidate_artifacts(ctx, cand, outcome):
        ...
        if manifest is None or not candidate_id:
            return
        from rincode.evolver.activation import (
            create_activation_artifacts,
        )
        from rincode.evolver.candidate_evidence import evaluate_candidate_evidence
