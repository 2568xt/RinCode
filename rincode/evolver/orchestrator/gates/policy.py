...
from rincode.evolver.orchestrator.scoring import EvalFn, EvaluationVerdict, TaskEval
...
if TYPE_CHECKING:
    from rincode.evolver.orchestrator.gates.paired import PairedResult
    from rincode.evolver.orchestrator.gates.pipeline import GateResult
    from rincode.evolver.orchestrator.nodes.screen import ScreenResult
