...
.. code-block::
    ...
    RinCode repo (Git)                    ← code state, white-listed via Git
...
from rincode.evolver.tree.node import (
    AppliedPatch,
    HarnessNode,
    NodeStatus,
)
...
class EvolverTreeStore:
    ...
    .. code-block:: python
        ...
        store = EvolverTreeStore(
            repo_root=Path("/path/to/rincode"),
            nodes_dir=Path("/path/to/rincode/evolver/nodes"),
        )
    ...
    def create_child_node(
        ...
        *,
        ...
        author_email: str = "evolver@rincode.local",
