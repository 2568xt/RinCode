...
模块把 :func:`rincode.evolver.analysis.stability_bucket.compute_stability` 的 per-task stability，
和 :func:`rincode.evolver.analysis.proxy_features.extract_trial_dir` 的 per-trial feature，组合为
:class:`rincode.evolver.scheduler.cold_start_bandit.ColdStartCoverageBandit` 消费的统一
:class:`Trial` view。
...
from rincode.evolver.analysis.proxy_features import (
    ExitStatus,
    ProxyFeatures,
    extract_trial_dir,
)
...
from rincode.evolver.scheduler.cold_start_bandit import Trial
