...
:mod:`rincode.evolver.tree.store`) and the in-memory bandit
(:mod:`rincode.evolver.scheduler.tree_aware_bandit`). This is the
...
from rincode.evolver.scheduler.tree_aware_bandit import TreeAwareTaskScheduler
