...
The YAML shape:
    ...
    models:                              # optional; omitted -> RinCode's own model
...
from rincode.evolver.launch.state import META_FILENAME
from rincode.evolver.orchestrator.config import (
    AnchorParams,
    Budget,
    OrchestratorConfig,
    Termination,
...
def _validate_work_dir(repo_root: Path, work_dir: Path) -> None:
    ...
    try:
        ...
        with tempfile.NamedTemporaryFile(prefix=".rincode-evolver-write-", dir=work_dir):
            pass
    except OSError as exc:
