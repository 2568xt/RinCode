...
from rincode.security.trust import wrap_untrusted
from rincode.tracing import semconv, trace
from rincode.utils.helpers import build_assistant_message
...
Summarize this naturally for the user. Keep it brief (1-2 sentences). Do not mention technical details like "subagent" or task IDs."""
    ...
    def _build_subagent_prompt(self) -> str:
        ...
        from rincode.memory_engine.skill_forge import LocalSkillCatalog
