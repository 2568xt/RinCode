...
from rincode.product import PRODUCT_LOGO, PRODUCT_NAME
from rincode.security.trust import wrap_untrusted
from rincode.utils.helpers import build_assistant_message, detect_image_mime
...
{skills_summary}""")
    ...
    def _get_identity(self) -> str:
        """渲染核心 Identity、Runtime、Workspace 与 RinCode Guidelines Section。
