...
def _build_parser() -> argparse.ArgumentParser:
    ...
    p.add_argument(
        ...
        "Use RinCode's data dir to inspect RinCode-managed VMs, e.g. "
        "$(uv run python -c 'from rincode.config.paths import get_sandbox_dir; print(get_sandbox_dir(\"boxlite\"))').",
    )
