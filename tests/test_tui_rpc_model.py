...
The five handlers wrap ``rincode.config.update_providers`` write/read helpers
...
from rincode.tui_rpc.errors import ConfigValidationError, NotSupportedInV01Error
from rincode.tui_rpc.methods.model import (
    model_add_model,
    model_disconnect,
    model_options,
    model_remove_model,
...
async def test_options_lists_providers_once(fake_home: Path, monkeypatch: pytest.MonkeyPatch) -> None:
    from rincode.tui_rpc.methods import model as model_methods
