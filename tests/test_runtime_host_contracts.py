...
from rincode.channels.contract import Capabilities, Channel
...
from rincode.providers.base import LLMResponse, StreamDelta, ToolCallRequest
from rincode.spine import ChatType, Origin, Source, TurnRequest
from rincode.tui_rpc.dispatcher import Dispatcher
from rincode.tui_rpc.methods import turn as turn_methods
from rincode.tui_rpc.methods.turn import register_turn_methods
...
async def test_protected_task_runs_through_cli_tui_and_gateway(
    ...
    monkeypatch.setattr("rincode.agent.tools.mcp.connect_mcp_servers", _connect_mcp)
    monkeypatch.setattr(
    ...
    for host in ("cli", "tui", "gateway"):
        ...
        workspace.mkdir()
        (workspace / "sentinel.txt").write_text("RINCODE_HOST_SENTINEL", encoding="utf-8")
