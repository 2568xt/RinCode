...
def test_skill_commands_use_current_project_state(
    ...
    from rincode.cli.skill_commands import _build_skill_service
...
def test_skill_list_renders_table(tmp_config: Path, monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    monkeypatch.setattr("rincode.cli.skill_commands._build_skill_service", lambda: fake_svc)
