...
def test_release_dist_target_uses_fail_closed_distribution_verifier(tmp_path: Path) -> None:
    result = subprocess.run(
        ["make", "-n", "release-dist"],
        cwd=REPO_ROOT,
        env={**os.environ, "RINCODE_RELEASE_OUTPUT": str(tmp_path / "release")},
        capture_output=True,
        text=True,
        check=False,
    )
...
def _write_wheel(
    ...
    files = {
        "rincode/__init__.py": "",
        "rincode/templates/AGENTS.md": "# Agents",
        "rincode/templates/SOUL.md": "# Soul",
        "rincode/tracing/viewer/server.js": "",
        "rincode/tracing/viewer/ui/app.js": "",
        "rincode/ui-tui/dist/entry.js": "",
        "rincode_harness-0.1.7.dist-info/METADATA": (
            "Metadata-Version: 2.4\n"
            "Name: rincode-harness\n"
            "Version: 0.1.7\n"
        ...
        "rincode_harness-0.1.7.dist-info/entry_points.txt": "[console_scripts]\nrincode = rincode.cli.commands:run\n",
        "rincode_harness-0.1.7.dist-info/licenses/LICENSE": "Apache-2.0",
        "rincode_harness-0.1.7.dist-info/licenses/LICENSES/MIT-hermes-agent.txt": "MIT",
        "rincode_harness-0.1.7.dist-info/licenses/LICENSES/MIT-ink.txt": "MIT",
        "rincode_harness-0.1.7.dist-info/licenses/LICENSES/MIT-nanobot.txt": "MIT",
        "rincode_harness-0.1.7.dist-info/licenses/LICENSES/MIT-pinchbench.txt": "MIT",
        "rincode_harness-0.1.7.dist-info/licenses/LICENSES/README.md": "# Third-party licenses",
        "rincode_harness-0.1.7.dist-info/licenses/NOTICES.md": "# Notices",
        "rincode_harness-0.1.7.dist-info/RECORD": "",
    }
...
def test_wheel_manifest_rejects_node_modules(tmp_path: Path) -> None:
    wheel = _write_wheel(
        tmp_path / "rincode_harness-0.1.7-py3-none-any.whl",
        {"rincode/node_modules/typescript/package.json": "{}"},
    )
    ...
    with pytest.raises(verify_distribution.VerificationError, match="node_modules"):
        ...
        verify_distribution._validate_wheel(snapshot, "rincode")


@pytest.mark.parametrize(
    "artifact",
    [
        "rincode/package.json",
        "rincode/package-lock.json",
        "rincode/.npmrc",
        "rincode/npm-debug.log",
        "rincode/reports/distribution.html",
        "ui-tui/src/entry.tsx",
        "rincode/generated/tool.ts",
        "rincode/distribution-report.json",
        "rincode/verification-report.html",
        "rincode/htmlcov/index.html",
        "rincode/coverage.xml",
    ],
)
...
@pytest.mark.parametrize("missing_notice", ["NOTICES.md", "LICENSES/MIT-pinchbench.txt"])
def test_wheel_manifest_requires_complete_attribution_set(tmp_path: Path, missing_notice: str) -> None:
    wheel = _write_wheel(
        tmp_path / "rincode_harness-0.1.7-py3-none-any.whl",
        remove_files={f"rincode_harness-0.1.7.dist-info/licenses/{missing_notice}"},
    )
...
@pytest.mark.parametrize(
    "runtime_file",
    [
        "rincode/bridge/package.json",
        "rincode/channels/adapters/whatsapp/channel.py",
        "rincode/channels/adapters/telegram/channel.py",
        "rincode/channels/adapters/slack/channel.py",
        "rincode/channels/adapters/discord/channel.py",
        "rincode/channels/adapters/matrix/channel.py",
        "rincode/channels/adapters/mochat/channel.py",
        "rincode/channels/adapters/dingtalk/channel.py",
        "rincode/channels/adapters/email/channel.py",
        "rincode/channels/adapters/weixin/channel.py",
    ],
)
...
def test_wheel_manifest_rejects_removed_media_generation_runtime(tmp_path: Path) -> None:
    wheel = _write_wheel(
        tmp_path / "rincode_harness-0.1.7-py3-none-any.whl",
        {"rincode/agent/tools/media_gen.py": ""},
    )

    with pytest.raises(verify_distribution.VerificationError, match="removed media generation runtime"):
        verify_distribution._validate_wheel(verify_distribution._wheel_snapshot(wheel), "rincode")


@pytest.mark.parametrize(
    "runtime_file",
    [
        "rincode/skill_hub/client.py",
        "rincode/agent/tools/skill_hub.py",
        "rincode/memory_engine/skill_forge/hub_source.py",
    ],
)
...
@pytest.mark.parametrize(
    "runtime_file",
    [
        "rincode/agent/tools/deep_research.py",
        "rincode/cli/deep_research_commands.py",
        "rincode/config/update_tools.py",
    ],
)
...
@pytest.mark.parametrize(
    "runtime_file",
    [
        "rincode/proactive_engine/sentinel/__init__.py",
        "rincode/cli/sentinel_commands.py",
        "rincode/cli/_proactive_stack.py",
        "rincode/memory_engine/consolidate/behaviors_extractor.py",
    ],
)
...
@pytest.mark.parametrize(
    "runtime_file",
    [
        "rincode/proactive_engine/schedulers/heartbeat/service.py",
        "rincode/proactive_engine/system_events.py",
        "rincode/proactive_engine/wake.py",
        "rincode/templates/HEARTBEAT.md",
    ],
)
...
def test_wheel_manifest_rejects_removed_cli_runtime(tmp_path: Path) -> None:
    wheel = _write_wheel(
        tmp_path / "rincode_harness-0.1.7-py3-none-any.whl",
        {"rincode/cli/upgrade_commands.py": ""},
    )
...
@pytest.mark.parametrize(
    "runtime_file",
    [
        "rincode_harness-0.1.7/bridge/package.json",
        "rincode_harness-0.1.7/rincode/channels/adapters/whatsapp/channel.py",
        "rincode_harness-0.1.7/rincode/channels/adapters/telegram/channel.py",
        "rincode_harness-0.1.7/rincode/channels/adapters/slack/channel.py",
        "rincode_harness-0.1.7/rincode/channels/adapters/discord/channel.py",
        "rincode_harness-0.1.7/rincode/channels/adapters/matrix/channel.py",
        "rincode_harness-0.1.7/rincode/channels/adapters/mochat/channel.py",
        "rincode_harness-0.1.7/rincode/channels/adapters/dingtalk/channel.py",
        "rincode_harness-0.1.7/rincode/channels/adapters/email/channel.py",
        "rincode_harness-0.1.7/rincode/channels/adapters/weixin/channel.py",
    ],
)
def test_sdist_manifest_rejects_removed_channel_runtime(tmp_path: Path, runtime_file: str) -> None:
    sdist = _write_sdist(tmp_path / "rincode_harness-0.1.7.tar.gz", {runtime_file: ""})
...
def test_sdist_manifest_rejects_removed_media_generation_runtime(tmp_path: Path) -> None:
    sdist = _write_sdist(
        tmp_path / "rincode_harness-0.1.7.tar.gz",
        {"rincode_harness-0.1.7/rincode/agent/tools/media_gen.py": ""},
    )
...
@pytest.mark.parametrize(
    "runtime_file",
    [
        "rincode_harness-0.1.7/rincode/skill_hub/client.py",
        "rincode_harness-0.1.7/rincode/agent/tools/skill_hub.py",
        "rincode_harness-0.1.7/rincode/memory_engine/skill_forge/hub_source.py",
    ],
)
...
@pytest.mark.parametrize(
    "runtime_file",
    [
        "rincode_harness-0.1.7/rincode/agent/tools/deep_research.py",
        "rincode_harness-0.1.7/rincode/cli/deep_research_commands.py",
        "rincode_harness-0.1.7/rincode/config/update_tools.py",
    ],
)
...
@pytest.mark.parametrize(
    "runtime_file",
    [
        "rincode_harness-0.1.7/rincode/proactive_engine/sentinel/__init__.py",
        "rincode_harness-0.1.7/rincode/cli/sentinel_commands.py",
        "rincode_harness-0.1.7/rincode/cli/_proactive_stack.py",
        "rincode_harness-0.1.7/rincode/memory_engine/consolidate/behaviors_extractor.py",
    ],
)
...
@pytest.mark.parametrize(
    "runtime_file",
    [
        "rincode_harness-0.1.7/rincode/proactive_engine/schedulers/heartbeat/service.py",
        "rincode_harness-0.1.7/rincode/proactive_engine/system_events.py",
        "rincode_harness-0.1.7/rincode/proactive_engine/wake.py",
        "rincode_harness-0.1.7/rincode/templates/HEARTBEAT.md",
    ],
)
...
def test_sdist_manifest_rejects_removed_cli_runtime(tmp_path: Path) -> None:
    sdist = _write_sdist(
        tmp_path / "rincode_harness-0.1.7.tar.gz",
        {"rincode_harness-0.1.7/rincode/cli/upgrade_commands.py": ""},
    )
...
def test_wheel_rejects_bundled_everos_runtime(tmp_path: Path) -> None:
    wheel = _write_wheel(
        tmp_path / "rincode_harness-0.1.7-py3-none-any.whl",
        {"rincode/plugin/memory/everos/backend.py": ""},
    )
...
def test_base_and_extras_use_distinct_environment_roots(tmp_path: Path) -> None:
    wheel = _write_wheel(tmp_path / "rincode_harness-0.1.7-py3-none-any.whl")
    snapshot = verify_distribution._wheel_snapshot(wheel)
...
def test_probe_environment_isolates_home_pythonpath_and_credentials(
    ...
    monkeypatch.setenv("ANTHROPIC_API_KEY_RINCODE", "secret")
    monkeypatch.setenv("OPENAI_API_KEY_RINCODE", "secret")
    ...
    for name in (
        "DEEPSEEK_API_KEY",
        "LARK_APP_SECRET",
        "ANTHROPIC_API_KEY_RINCODE",
        "OPENAI_API_KEY_RINCODE",
        "NPM_TOKEN",
        "UV_INDEX_PASSWORD",
        "SSH_AUTH_SOCK",
    ):
...
def test_source_snapshot_includes_nonignored_files_without_touching_checkout(
    ...
    subprocess.run(["git", "config", "user.name", "RinCode Test"], cwd=checkout, check=True)
    subprocess.run(["git", "config", "user.email", "rincode@example.com"], cwd=checkout, check=True)
...
def test_sdist_wheel_must_match_direct_wheel_resources(tmp_path: Path) -> None:
    ...
    direct = verify_distribution._wheel_snapshot(
        _write_wheel(tmp_path / "direct" / "rincode_harness-0.1.7-py3-none-any.whl")
    )
    rebuilt_path = tmp_path / "rebuilt" / "rincode_harness-0.1.7-py3-none-any.whl"
    rebuilt_path.parent.mkdir()
    rebuilt = verify_distribution._wheel_snapshot(_write_wheel(rebuilt_path, {"rincode/templates/SOUL.md": "changed"}))
...
def test_unconfigured_doctor_exit_one_is_expected() -> None:
    expected_path = Path("/isolated/home/.rincode/config.json")
    completed = subprocess.CompletedProcess(
        args=["rincode", "doctor", "--json"],
        returncode=1,
        stdout=json.dumps(
            {
                "paths": {
...
def test_package_probe_requires_contracted_cli_surface(tmp_path: Path) -> None:
    plan = verify_distribution.InstallPlan("base", tmp_path, "rincode.whl", ())
    payload = {
        "package": str(tmp_path / "lib" / "rincode" / "__init__.py"),
        "tui": str(tmp_path / "lib" / "rincode" / "ui-tui" / "dist" / "entry.js"),
...
def test_rincode_module_probe_requires_rincode_version_output(tmp_path: Path) -> None:
    plan = verify_distribution.InstallPlan("base", tmp_path, "rincode.whl", ())
    healthy = subprocess.CompletedProcess(
        args=[sys.executable, "-I", "-m", "rincode", "--version"],
        returncode=0,
        stdout="RinCode v0.1.7\n",
        stderr="",
    )

    verify_distribution._validate_rincode_module_probe(healthy, plan)
    ...
    with pytest.raises(verify_distribution.VerificationError, match="cannot run the RinCode module entrypoint"):
        verify_distribution._validate_rincode_module_probe(stale, plan)


def test_product_path_probe_requires_rincode_roots(tmp_path: Path) -> None:
    import hashlib
    ...
    report = {
        "product_home": str(home / ".rincode"),
        "workspace_state": str(home / ".rincode" / "projects" / f"workspace-{digest}"),
        "plugin_user": str(home / ".rincode" / "plugins"),
        "plugin_project": None,
        "plugin_entrypoints": "rincode.plugins",
    }
    ...
    report["workspace_state"] = str(home / ".rincode" / "projects" / f"workspace-{digest}")
    report["plugin_project"] = str(cwd / ".rincode" / "plugins")
...
def test_distribution_handoff_publishes_exact_wheel_and_base_environment(
    ...
    wheel = tmp_path / "dist" / "rincode_harness-0.1.7-py3-none-any.whl"
    python = tmp_path / "envs" / "base" / "bin" / "python"
    entrypoint = tmp_path / "envs" / "base" / "bin" / "rincode"
    ...
    environments = [
        {
            ...
            "entrypoint": str(tmp_path / "envs" / "channel-feishu" / "bin" / "rincode"),
        },
        {
            "name": "base",
...
def test_gateway_probe_config_is_offline_and_disables_optional_runtime_paths() -> None:
    ...
    assert config == {
        "agents": {
            "defaults": {
                "model": "ollama/rincode-distribution-probe",
                "provider": "ollama",
            }
        },
        "channels": {
...
def test_gateway_probe_supervises_health_and_bounded_shutdown(tmp_path: Path) -> None:
    executable = _write_fake_gateway(tmp_path / "rincode")
    records: list[dict] = []
...
def test_installed_tui_probe_has_a_bounded_timeout(
    ...
    verify_distribution._probe_base_runtime_surfaces(
        plan,
        executable=tmp_path / "envs" / "base" / "bin" / "rincode",
        probe_cwd=tmp_path,
        probe_env=_isolated_env(tmp_path),
        log_dir=tmp_path / "logs",
        records=[],
    ...
    assert captured["command"] == [str(tmp_path / "envs" / "base" / "bin" / "rincode"), "--check"]
