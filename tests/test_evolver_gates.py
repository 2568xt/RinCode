"""Unit tests for the gate arithmetic (rincode.evolver.orchestrator.gates).
...
from rincode.evolver.orchestrator.gates.fisher import (
    fisher_one_sided,
    focused_counts,
    train_mean,
)
from rincode.evolver.orchestrator.gates.paired import paired_lift
from rincode.evolver.orchestrator.gates.pipeline import run_gates
from rincode.evolver.orchestrator.gates.policy import Baseline, CandidateOutcome, DecisionContext
from rincode.evolver.orchestrator.gates.strategies import (
    FocusedFisherGate,
    PairedTwoSigmaGate,
    confirm_job_name,
)
from rincode.evolver.orchestrator.loop import RoundResult
