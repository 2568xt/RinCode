"""Unit tests for ``rincode.config.update_providers`` — the provider write path."""
...
from rincode.config.update_providers import test_provider as probe_provider


@pytest.fixture
def cfg_path(tmp_path: Path) -> Path:
    """Sandboxed config path; the real ``~/.rincode/config.json`` is never touched."""
