...
from benchmarks.rincodebench.scorecard_campaign import (
...
def test_makefile_exposes_scorecard_estimate_and_ship() -> None:
    ...
    assert "rincodebench-scorecard-estimate:" in makefile
    assert "rincodebench-scorecard-ship:" in makefile
