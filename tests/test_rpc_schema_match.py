"""Schema-match test: Pydantic models (rincode.tui_rpc.models) ↔ OpenRPC schema.
...
from rincode.tui_rpc.models import METHOD_MODELS
...
def test_registered_method_set_matches_schema(methods_by_name: dict[str, dict[str, Any]]) -> None:
    ...
    from rincode.tui_rpc.methods import register_aligned_methods
