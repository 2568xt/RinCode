...
from rincode.channels.adapters.feishu.channel import FeishuChannel
from rincode.channels.outlet import ChannelOutletAdapter
from rincode.spine import ChatType, Notice, NoticeKind, Source, Text
from rincode.spine.delivery import DeliveryHub, TerminalDeliveryError
...
def test_transcribe_prefers_native_feishu_stt(monkeypatch):
    ...
    monkeypatch.setattr("rincode.channels.adapters.feishu.channel.transcribe_audio", groq)
...
def test_transcribe_skips_native_once_disabled(monkeypatch):
    ...
    monkeypatch.setattr(
        "rincode.channels.adapters.feishu.channel.transcribe_audio",
...
def test_feishu_satisfies_channel_contract():
    from rincode.channels import Channel
    from rincode.channels.contract import capability_violations
...
def test_feishu_spec_import_is_cheap():
    ...
    code = (
        "import sys, rincode.channels.adapters.feishu.spec as s;"
