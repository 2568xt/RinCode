...
from rincode.sandbox.boxlite_executor import BoxliteExecutor
...
class TestDirectExecutor:
    ...
    async def test_host_env_not_inherited(self, monkeypatch):
        ...
        monkeypatch.setenv("RINCODE_TEST_SECRET", "leak-me")
        e = DirectExecutor()
        result = await e.exec("echo secret=[$RINCODE_TEST_SECRET]")
...
class TestBoxliteCleanupOrdering:
    ...
    async def test_owned_ids_kept_until_after_box_stop(self, tmp_path, monkeypatch):
        ...
        from rincode.sandbox import _runtime as rt_mod
...
class TestSubagentSandboxLifecycle:
    async def test_run_subagent_starts_and_stops_executor(self, mock_provider, tmp_path):
        ...
        from rincode.agent.subagent.manager import SubagentOutcome, SubagentStatus
        ...
        import rincode.agent.subagent.manager as subagent_mod
    ...
    async def test_announce_result_submits_subagent_origin_fire_and_forget(self, mock_provider, tmp_path):
        ...
        from rincode.agent.subagent import SubagentManager
        from rincode.agent.subagent.manager import SubagentStatus
...
def test_build_executor_warns_when_backend_none(monkeypatch, tmp_path):
    ...
    import rincode.sandbox as sandbox_mod
    from rincode.sandbox import SandboxConfig, build_executor
