...
from rincode.agent.hook import AgentHook, CompositeHook
from rincode.cli._eval_stack import build_eval_stack
from rincode.cli._hooks_stack import build_hooks_stack
from rincode.cli._token_wise_stack import install_from_config
from rincode.eval_engine import EvalEngine, EvalEngineConfig
...
class TestBuildEvalStack:
    ...
    async def test_default_hooks_are_noops_when_mounted_into_chain(self):
        from rincode.agent.hook.base import AgentHookContext
...
class TestInstallFromConfig:
    ...
    def test_returns_strategy_registry(self):
        from rincode.config.rincode import TokenWiseConfig
        from rincode.token_wise import StrategyRegistry
    ...
    def test_module_path(self):
        ...
        catch any test still trying ``rincode.token_wise.install``."""
        from rincode.cli import _token_wise_stack

        assert hasattr(_token_wise_stack, "install_from_config")

    def test_old_module_path_is_gone(self):
        with pytest.raises(ModuleNotFoundError):
            import rincode.token_wise.install  # noqa: F401
