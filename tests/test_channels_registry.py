"""Tests for rincode.channels.registry — adapter auto-discovery (spec-based)."""

from rincode.channels.contract import Capabilities, ChannelSpec
from rincode.channels.registry import discover_channel_names, discover_specs
...
def test_discover_specs_is_cheap():
    ...
    code = (
        "import sys; from rincode.channels.registry import discover_specs; discover_specs();"
