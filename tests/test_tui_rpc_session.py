...
from rincode.tui_rpc.errors import SessionNotFoundError, TurnInProgressError
from rincode.tui_rpc.methods import image as image_module
from rincode.tui_rpc.methods import session as session_module
from rincode.tui_rpc.methods import turn as turn_module
from rincode.tui_rpc.methods.image import image_attach, pending_images
from rincode.tui_rpc.methods.session import (
...
from rincode.utils.atomic_io import StorageCorruptionError
...
async def test_session_clear_keeps_id_and_wipes(tmp_path):
    from rincode.tui_rpc.methods.session import session_clear
...
async def test_session_clear_save_failure_returns_false_and_rolls_back_memory(
    ...
    monkeypatch.setattr("rincode.session.manager.atomic_replace", _boom_replace)
...
async def test_session_undo_drops_last_turn(tmp_path):
    from rincode.tui_rpc.methods.session import session_undo
...
async def test_session_export_writes_verified_portable_artifact(
    ...
    assert written.name.endswith(".rincode-session.json")
...
async def test_session_export_uses_live_manager_state_directory(
    ...
    project_state = tmp_path / "project" / ".rincode"
    cfg = load_config()
