...
from rincode.agent.hook import AgentHook, AgentHookContext, CompositeHook, HookDecision
...
from rincode.config.schema import ToolSearchConfig
from rincode.providers.base import ErrorClassification, LLMProvider, LLMResponse, StreamDelta, ToolCallRequest
from rincode.sandbox import SandboxInitError
from rincode.spine.events import MediaOut as EvMediaOut
from rincode.spine.events import Notice as EvNotice
from rincode.spine.events import NoticeKind, ToolPhase
from rincode.spine.events import Reasoning as EvReasoning
from rincode.spine.events import StreamDelta as EvStreamDelta
from rincode.spine.events import Text as EvText
from rincode.spine.events import ToolEvent as EvToolEvent
...
async def test_help_slash_returns_command_list_at_outbound_layer(tmp_path):
    ...
    content, _media = out
    assert "RinCode commands" in content
...
async def test_run_slash_emits_text_not_streamed(tmp_path):
    ...
    assert len(texts) == 1 and "RinCode commands" in texts[0].content
