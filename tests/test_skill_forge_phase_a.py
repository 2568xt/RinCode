...
from rincode.memory_engine.skill_forge.catalog import _escape_xml
from rincode.memory_engine.skill_local import SkillRegistry
from rincode.memory_engine.skill_local.registry import (
    _check_requirements,
...
def tmp_builtin(tmp_path: Path):
    ...
    _write_skill(
        ...
        frontmatter_extra='metadata: {"rincode":{"always":true}}',
    )
    ...
    _write_skill(
        ...
        frontmatter_extra='metadata: {"rincode":{"requires":{"bins":["this_bin_does_not_exist_xyz"]}}}',
    )
...
class TestFrontmatterParsing:
    ...
    def test_nested_metadata_rincode_wins(self):
        raw = '{"rincode": {"emoji": "🔧"}, "nanobot": {"emoji": "🤖"}}'
