...
def test_intake_submit_path_builds_turnrequest():
    from rincode.spine import ChatType, Origin
...
def test_intake_submit_path_dm_default_and_no_conversation():
    from rincode.spine import ChatType
...
def test_transcribe_audio_delegates(monkeypatch):
    ...
    monkeypatch.setattr("rincode.providers.transcription.GroqTranscriptionProvider", _FakeProvider)
...
def test_transcribe_audio_swallows_errors(monkeypatch):
    ...
    monkeypatch.setattr("rincode.providers.transcription.GroqTranscriptionProvider", _Boom)
...
def test_transcribe_audio_empty_key_becomes_none(monkeypatch):
    ...
    monkeypatch.setattr("rincode.providers.transcription.GroqTranscriptionProvider", _Rec)
