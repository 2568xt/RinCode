...
from rincode.providers.common_models import common_models_for
from rincode.providers.registry import PROVIDERS, find_by_name
...
def _concrete_provider_subclasses() -> set[type]:
    """All non-abstract LLMProvider subclasses defined in rincode.providers."""

    import rincode.providers.azure_openai_provider  # noqa: F401
    import rincode.providers.custom_provider  # noqa: F401
    import rincode.providers.lazy  # noqa: F401
    import rincode.providers.litellm_provider  # noqa: F401
    import rincode.providers.openai_codex_provider  # noqa: F401
    import rincode.providers.per_model_provider  # noqa: F401
    ...
    while stack:
        ...
        if getattr(cls, "__abstractmethods__", frozenset()):
            continue
        if cls.__module__.startswith("rincode.providers"):
            seen.add(cls)
    return seen
...
def test_exactly_six_concrete_backend_classes() -> None:
    ...
    from rincode.providers.custom_provider import CustomProvider
