...
RinCode has no OTEL dependency and no `rincode/**` module imports opentelemetry.
...
def test_no_rincode_module_imports_opentelemetry():
    root = Path(rincode.__file__).resolve().parent
    offenders = [
