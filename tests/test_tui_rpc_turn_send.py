...
Spec source:
- ``rincode/tui_rpc/models.py`` ``TurnSendParams`` / ``TurnSendResult``
"""
...
from rincode.tui_rpc.errors import ModelNotAvailableError, RpcError, TurnInProgressError
from rincode.tui_rpc.methods.image import image_attach, pending_images
from rincode.tui_rpc.methods.turn import register_turn_methods, turn_send
...
def _clear_active_turns():
    from rincode.tui_rpc.methods import turn as _turn_mod
...
async def test_turn_send_binds_active_slot_after_submit() -> None:
    from rincode.tui_rpc.methods import turn as turn_mod
...
async def test_turn_send_rejects_unknown_model_with_minus_32008() -> None:
    with patch(
        "rincode.tui_rpc.methods.turn._resolve_model",
...
async def test_turn_send_when_submit_rejected_surfaces_turn_failed() -> None:
    ...
    from rincode.spine.scheduler import SchedulerDrainingError
    from rincode.tui_rpc.methods import turn as turn_mod
