...
from rincode.channels.adapters.qq import parsing as qp
from rincode.channels.adapters.qq.channel import QQChannel
...
def test_qq_spec_declares_beta_maturity():
    from rincode.channels.adapters.qq.spec import SPEC
...
def test_qq_spec_factory_raises_import_error_without_sdk(monkeypatch):
    ...
    monkeypatch.delitem(sys.modules, "rincode.channels.adapters.qq.channel", raising=False)
...
def test_qq_spec_import_is_cheap():
    ...
    code = (
        "import sys, rincode.channels.adapters.qq.spec as s;"
