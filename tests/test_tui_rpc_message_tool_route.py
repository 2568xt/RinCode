...
``TuiTurnRunner`` (rincode/tui_rpc/spine.py). AC-1/AC-4 drive the real spine via
...
from rincode.agent.loop import AgentLoop, TurnOutcome
from rincode.agent.tools.message import MessageTool
from rincode.providers.base import StreamDelta
