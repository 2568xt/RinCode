...
from rincode.spine.delivery import Outlet, SupportsStreaming
from rincode.spine.message import Media
from rincode.tui_rpc.spine import (
    TuiOutlet,
    TuiTurnRunner,
    build_tui,
)
...
async def test_turn_send_rejects_instead_of_queueing_behind_system_turn(system_state):
    from rincode.tui_rpc.errors import TurnInProgressError
    from rincode.tui_rpc.methods import turn as turn_module
    from rincode.tui_rpc.methods.turn import turn_send
