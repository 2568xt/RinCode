...
from rincode.auth.allowlist import reset_warning_state
...
class TestAllowlistSemantics:
    ...
    def test_warning_logged_once_for_empty_list(self, caplog):
        with caplog.at_level(logging.WARNING, logger="rincode.auth.allowlist"):
...
class _StubChannel:
    ...
    from rincode.channels.base import ChannelBase  # noqa: E402
