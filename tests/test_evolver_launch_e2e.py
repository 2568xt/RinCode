...
from rincode.evolver.launch import runner as runner_mod
from rincode.evolver.launch.contract import BenchBundle
from rincode.evolver.launch.state import RunMeta
...
def fake_bench(monkeypatch):
    ...
    def build(ctx) -> BenchBundle:
        ...
        from rincode.evolver.orchestrator.scoring import EvalBackend, TaskEval
