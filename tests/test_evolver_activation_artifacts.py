...
from rincode.evolver.activation.artifacts import (
    ActivationState,
    EvidenceDecision,
    EvidenceOutcome,
    _canonical_json,
...
from rincode.evolver.activation.summary import (
    build_evolution_summary,
    write_evolution_summary,
)
from rincode.evolver.candidate_evidence import AcceptedRuntimeEvidence
from rincode.evolver.candidate_manifest import LABEL_POLICIES, CandidateLabel
from rincode.evolver.orchestrator.scoring import TaskEval
...
_TARGET_BY_LABEL = {
    CandidateLabel.skill: "rincode/memory_engine/skills/example/SKILL.md",
    CandidateLabel.prompt: "rincode/templates/AGENTS.md",
