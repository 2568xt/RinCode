...
from benchmarks.rincodebench.packs.context.runner import (
    _RoleScopedProvider,
    _trial_configs,
)
from benchmarks.rincodebench.packs.context.runner import (
...
from rincode.context_engine.base import AssembledPrefix, AssemblyContext
...
from rincode.providers.base import ErrorClassification, GenerationSettings
...
def test_context_trial_binds_curator_to_frozen_campaign_model(
    ...
    rincode_config.context.curator_model = "gemini-2.5-flash"

    trial_config, trial_rincode = _trial_configs(
        config,
        rincode_config,
        workspace=tmp_path,
    ...
    assert trial_rincode.context.curator_model == "deepseek/deepseek-v4-flash"
    assert trial_config.agents.defaults.max_tokens == 500
    assert trial_rincode.context.protect_first_n == 1
