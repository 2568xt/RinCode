...
from rincode.cli._plugin_stack import MynaSetupError, build_plugin_registry, maybe_build_memory_backend
...
def _config(memory_backend: str | None = "myna") -> RinCodeConfig:
...
def _registry(
    *,
    ...
    factory_ref: str = "myna.integrations.rincode:make_backend",
...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("myna-memory", "myna.integrations.rincode.backend:make_backend"),
    ],
)
...
""".strip(),
    ...
    monkeypatch.setattr(
        "rincode.cli._plugin_stack.plugin_discovery_sources",
        lambda: {
            "bundled_dir": None,
