...
from rincode.tui_rpc.methods.turn import turn_cancel, turn_send, turn_subscribe
from rincode.tui_rpc.models import TurnEvent
    ...
    class _StubAgent:
        ...
        async def run_turn(
            ...
            *,
            ...
            from rincode.spine import TurnOutcome, Usage
...
async def test_overflow_error_event_payload_shape() -> None:
    ...
    from rincode.tui_rpc.subscriptions import QUEUE_CAPACITY
