"""CLI tests for ``rincode provider``.
...
def test_provider_help_works() -> None:
    """``rincode provider --help`` lists the subcommands."""
...
def test_provider_login_help_lists_argument() -> None:
    """``rincode provider login --help`` surfaces the PROVIDER argument."""
...
def test_test_command_success_renders_models_count(
    ...
    from rincode.config import update_providers
