...
``rincode/token_wise/EXPERIMENT_REPORT_WORKLOADS.md``.
...
REPORT_PATH = Path(__file__).resolve().parent.parent / "rincode" / "token_wise" / "EXPERIMENT_REPORT_WORKLOADS.md"
...
def _medium_soul() -> str:
    ...
    return (
        "# Soul\n\n"
        "I am RinCode, a careful assistant. I reply concisely and never invent facts.\n\n"
        "## Working principles\n\n"
